...
public class Grille {
	...
	// parce qu'on prend une classe Grille (Grille grille) en entr�e qui elle m�me
	// d�clare
	...
	public void echange(int ls, int cs, int lt, int ct) throws CandyException {
		...
		//Si aucune combinaison n'est d�tect�e on remet les bonbons � leurs places et on jette une exception
