...
public class Application {
	...
	private static void jouer(Grille grille) throws Exception {
		...
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(8, 7));
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(7, 7));
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(6, 7));
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(5, 7));
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(4, 7));
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(3, 7));
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(2, 7));
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(1, 7));
		System.out.println("Bonbon en (9,7): " + grille.getCouleur(0, 7));
